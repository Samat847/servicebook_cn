      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTermsSection(
              '1. Принятие условий',
              'Загружая, устанавливая или используя приложение ServiceBook ("Приложение"), вы соглашаетесь соблюдать настоящие Условия использования. Если вы не согласны с этими условиями, пожалуйста, не используйте Приложение.',
            ),

            _buildTermsSection(
              '2. Описание услуг',
              'ServiceBook предоставляет пользователям инструменты для:\n\n'
            ...
            _buildTermsSection(
              ...
              'Все права на Приложение, включая дизайн, код, логотипы и контент, принадлежат компании ServiceBook или ее лицензиарам. Пользователям предоставляется ограниченная, неисключительная, непередаваемая лицензия на использование Приложения.',
            ),
            ...
            _buildTermsSection(
              ...
              'В максимальной степени, разрешенной законом, компания ServiceBook не несет ответственности за:\n\n'
